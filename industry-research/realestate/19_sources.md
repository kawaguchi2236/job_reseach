...
## §G. 05_departments.md で追加引用した法令（team-lead が法令IDを確定：2026-09-18）

`05_departments.md` の執筆時に引用したが、本ファイルに未収録だったもの。
**法令IDは e-Gov の法令名検索API（`https://laws.e-gov.go.jp/api/2/laws?law_title=...`）で確認済み。**

| 法令 | 引用した条項 | 法令ID | 使用箇所 |
|---|---|---|---|
| **不当景品類及び不当表示防止法**（景表法・昭和37年法律第134号） | 第36条第1項 | `337AC0000000134` | ⑥販促・集客、PART 3 |
| **不動産の表示に関する公正競争規約** | 第1条、**第21条（おとり広告）** | （告示・規約のため法令IDなし。公正取引委員会／不動産公正取引協議会連合会） | ②賃貸仲介、⑥、⑨、PART 3 |
| **所得税法** | 第183条第1項（源泉徴収・**翌月10日まで**） | `340AC0000000033` | ⑦経理・財務、⑧人事・総務 |
| **法人税法** | 第74条第1項（事業年度終了の日の翌日から**2月以内**） | `340AC0000000034` | ⑦経理・財務 |
| **消費税法** | 第45条第1項（課税期間の末日の翌日から**2月以内**） | `363AC0000000108` | ⑦経理・財務 |
| **個人情報の保護に関する法律** | 第17条第1項、第23条、第27条第1項 | `415AC0000000057` | ⑧人事・総務、PART 3 |
| **労働基準法** | 第15条第1項、第32条、第36条第1項、第37条第1項、第107条第1項、第108条 | `322AC0000000049` | ⑧人事・総務 |
| **労働安全衛生法** | 第66条第1項 | `347AC0000000057` | ⑧人事・総務 |

### 既収録の宅地建物取引業法について `used_for` の追加が必要な条項
- **第22条の2**（宅地建物取引士証。**有効期間5年**、交付申請前**6月以内**の講習）… ⑧人事・総務
- **第9条**（変更の届出。**30日以内**）… ⑨免許・コンプライアンス管理
- **第48条第1項**（従業者証明書の携帯）、**第48条第3項**（事務所ごとの従業者名簿）… ⑧

### QAへの申し送り
上記は**法令IDとURLを確定したが、条文本文の逐語確認は team-lead 側では未実施**
（`05_departments.md` の執筆者が条文を確認したうえで引用している）。
QAは条文本文と本文記述の整合を点検すること。特に
**不動産の表示に関する公正競争規約は法令ではなく公正競争規約**（景表法第36条に基づき
公正取引委員会・消費者庁長官の認定を受けたもの）である点を、本文が正確に書き分けているか確認すること。

→ **対処済み（Phase D / 2026-09-21）。e-Gov法令API で条文本文を取得して逐語照合した。**

| 確認した条項 | 条文の語 | 本文の記述 | 判定 |
|---|---|---|---|
| 法人税法 第74条第1項 | 「各事業年度終了の日の翌日から**二月以内**に…確定した決算に基づき…申告書を提出」 | 「事業年度終了の日の翌日から2月以内」 | **一致** |
| 消費税法 第45条第1項 | 「課税期間ごとに、当該課税期間の末日の翌日から**二月以内**に…申告書を税務署長に提出」 | 「課税期間の末日の翌日から2月以内」 | **一致** |
| 景表法 第36条第1項 | 「事業者又は事業者団体は…**内閣総理大臣及び公正取引委員会の認定**を受けて…協定又は規約を締結し、又は設定することができる」 | 15-5 の条文引用は一致。ただし同節の「★★最重要の区別」欄のみ**「公正取引委員会・消費者庁長官の認定」**と書いており、**同じ節の中で認定主体の表記が食い違っていた** | **要修正 → 修正済**（下記） |
| 宅建業法 第22条の2第2項・第3項 | 「交付の申請前**六月以内**に行われる…講習を受講」／「宅地建物取引士証…の有効期間は、**五年**とする」 | 「有効期間5年」「交付申請前6月以内の講習」 | **一致** |
| 宅建業法 第9条 | 「…変更があつた場合においては…**三十日以内**に…届出書を…提出」 | 「変更の届出。30日以内」 | **一致** |
| 宅建業法 第48条第1項・第3項 | 「従業者に、その従業者であることを証する証明書を携帯させなければ…業務に従事させてはならない」／「**その事務所ごとに、従業者名簿を備え**…記載しなければならない」 | 「従業者証明書の携帯」「事務所ごとの従業者名簿」 | **一致** |
| 犯収法 第2条第2項**第四十二号** | 「四十二　宅地建物取引業法（昭和二十七年法律第百七十六号）第二条第三号に規定する**宅地建物取引業者**」 | 「第2条第2項第四十二号は宅建業者を特定事業者に」 | **一致**（号番号も正しい） |
| 犯収法 第4条第1項 | 「別表の上欄に掲げる特定事業者の区分に応じ…同表の下欄に定める取引を行うに際しては…確認を行わなければならない」 | 「取引時確認」。**別表は「売買又はその代理若しくは媒介」が対象で、貸借の媒介は含まれない**という書き分けが `15_rules-customs` 15-6／`16_glossary` (15)／`17_slides` **Slide 47・Slide 49・Slide 52** にある | **一致** |

**修正内容（`15_rules-customs.md` 15-5「★★最重要の区別」欄）**

> 修正前：「景品表示法第36条第1項の規定に基づき、**公正取引委員会・消費者庁長官の認定**を受けて設定された公正競争規約です。」
> 修正後：「景品表示法第36条第1項の規定に基づき認定を受けて設定された公正競争規約です。
...
**「表示規約は法令ではない」という書き分けそのものは、全ファイルで正確だった。**
`grep -n "法令ではな" realestate/*.md` のヒット**34件**をすべて目視した。内訳は次のとおりで、
**誤りは1件も無かった**（上記「★★最重要の区別」欄の認定主体の食い違い1件を除く）。

| 対象 | 件数 | 判定 |
|---|---:|---|
| **不動産の表示に関する公正競争規約**が法令でないことの明示（`07` 2／`09` 2／`11` 2／`13` 2／`14` 1／`15` 3／`16` 3／`17` 7／`19` 1） | 23 | **すべて正しい** |
| **国土交通省「原状回復をめぐるトラブルとガイドライン」**が法令でないことの明示（`02` 996行／`05` 1677行） | 2 | **正しい**（ガイドラインは指針であり法令ではない） |
| **商習慣**が法令でないことの明示（`15` 779・918行／`16` 451行／`17` 2722・2725・2949行） | 6 | **正しい** |
| 本ファイル（`19_sources.md`）内の記述 | 3 | — |

---

## §H. 横断ファイル（06〜16）で追加確認した法令（2026-09-20）

| 法令 | 法令ID | 確認した条項 |
|---|---|---|
| **賃貸住宅の管理業務等の適正化に関する法律施行規則** | `502M60000800083` | **第40条第1項**（管理業務報告書。「**管理受託契約を締結した日から一年を超えない期間ごとに、及び管理受託契約の期間の満了後遅滞なく**」）、第36条（分別管理の方法）、第38条（帳簿） |
| **犯罪による収益の移転防止に関する法律** | `419AC0000000022` | 第2条第2項第四十二号（宅建業者を特定事業者に）、第4条第1項（取引時確認）、別表（第4条関係）。**貸借の媒介は別表に含まれない** |
| 民法（追加） | `129AC0000000089` | 第86条第1項・第2項（不動産の定義） |
| 借地借家法（追加） | `403AC0000000090` | **第31条**（建物賃貸借の対抗力＝登記がなくても引渡しで効力） |
| 消費税法（追加） | `363AC0000000108` | **第6条第1項・別表第二第十三号**（住宅の貸付けの非課税） |
| 賃貸住宅管理業法（追加） | `502AC0000000060` | 第2条（維持保全の定義）、第15条（再委託の制限）、第17条（従業者証明書）、第18条（帳簿）、第19条（標識）、**第20条の条文本文**（※§1の note が「未取得」としていたが逐語引用済み） |
| 宅建業法施行規則（追加） | — | 第17条の2（従業者名簿の記載事項・**10年保存**）、第18条（帳簿の記載事項・**5年保存**） |
| 宅建業法（追加） | `327AC1000000176` | 第34条第1項・第2項（取引態様の明示）、第31条第1項（業務処理の原則） |

### team-lead が条文で検証した事項（2026-09-20）
**賃貸住宅管理業法施行規則第40条第1項**を e-Gov で取得し、逐語を確認した。
これにより `04_end-to-end-process.md` の A-16（オーナー報告）が
「実務上は月次または定期的に行う」という不正確な記述だったことが判明し、
条文どおりの期限に修正した。**法令に期限の定めがある事項を「実務上」で片付けない。**

### QAへの申し送り
- **建築基準法の接道義務**：`04` B-04 と本文で「建築基準法による」と記述しているが**条文番号が未特定**。
  QAで条文を特定して出典に追加すること
  → **対処済み（Phase D / 2026-09-21）。e-Gov法令API で条文本文を取得して特定した。**
- `03_company-structure.md` の賃貸住宅管理業の登録番号表記の様式は出典で未確認（軽微）
  → **未対処**（下記 §I 参照）

---

## §I. Phase D（QA）で追加確認した法令（2026-09-21）

```
- source_title   : 建築基準法（昭和二十五年法律第二百一号）
  organization   : e-Gov法令検索（デジタル庁）／法令所管：国土交通省
  url            : https://laws.e-gov.go.jp/law/325AC0000000201
                   （API）https://laws.e-gov.go.jp/api/2/law_data/325AC0000000201?response_format=json
  published_date : 昭和25年5月24日公布（本プロジェクト取得時点の最新版）
  accessed_date  : 2026-09-21
  used_for       : ・第43条第1項（接道義務。「建築物の敷地は、道路…に二メートル以上接しなければ
                     ならない」）［04_end-to-end-process B-04／05_departments B-04／
                     09_information／10_documents／16_glossary］
                   ・第42条第1項（「道路」の定義＝幅員四メートル以上。特定行政庁が指定する
                     区域内は六メートル）［同上］
  note           : 第43条第2項に適用除外（各号のいずれかに該当する建築物）、第3項に地方公共団体が
                   条例で制限を付加できる旨の定めがある。第42条第2項に、幅員四メートル未満でも
                   特定行政庁の指定により道路とみなされるもの（いわゆる二項道路）の定めがある。
                   本資料はこれらの例外の詳細には立ち入っていない。
```

### 本文が条文の引用の中でのみ言及している法令（独立した出典登録は行っていない）
- **都市計画法第29条第1項・第2項**、**建築基準法第6条第1項** … いずれも
  **宅建業法第33条（広告の開始時期の制限）の条文の中に登場する引用**であり、
  本資料はこれらの法律の要件そのものを説明していない（`02` 459行／`05` 4483行／
  `09` 379行／`15` 305行／`16` 75行）。**引用されている限りで言及するにとどめている。**
  ※ 建築基準法は接道義務（第43条第1項・第42条第1項）の根拠として上記に独立登録した。

### 未確認のまま残した事項（Phase D）
- **賃貸住宅管理業の登録番号の表記様式**：`03_company-structure.md` の
  「国土交通大臣（○）第○○○○号」の様式について、**様式を定める出典を確認できていない**。
  賃貸住宅管理業法施行規則には登録簿の記載事項の定めはあるが、登録番号の表記様式そのものを
  定める条文は特定できなかった。**本資料では `【Example】` として扱い、断定していない。**

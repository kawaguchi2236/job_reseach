...
| # | 業界 | フォルダ | 状態 |
|---|---|---|---|
| 1 | 製造業 | `manufacturing/` | ✅ 完成 |
| 2 | 建設業 | `construction/` | ✅ 完成 |
| 3 | 卸売業 | `wholesale/` | ✅ 完成 |
| 4 | 小売業 | `retail/` | ✅ 完成 |
| 5 | 運輸・物流業 | `logistics/` | ✅ 完成 |
| 6 | 飲食業 | `restaurant/` | ✅ 完成 |
| 7 | 宿泊業 | `hotel/` | ✅ 完成 |
| 8 | 不動産業 | `realestate/` | ✅ 完成 |
| 9 | 医療 | `medical/` | ✅ 完成 |
| 10 | 介護・福祉 | `care/` | ✅ 完成 |
| 11 | 情報通信業 | `ict/` | ✅ 完成 |
| 12 | 専門サービス業 | `professional/` | ✅ 完成 |

**最終成果物：[`industry-index.md`](industry-index.md)** — 全12業界の横断索引。
一覧表（主要顧客・提供価値・売上の源泉・機能・業務フロー・モノの有無・カネの特徴）、
業界ごとの1ページ要約、横断的な視点（カネの入り方／許認可の重さ／「モノ」が何か／
記録が報酬に直結する業界）、**この資料の限界**（確認できなかった29項目）を収録。

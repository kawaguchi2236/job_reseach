...
| # | 業界 | フォルダ | 状態 |
|---|---|---|---|
| 1 | 製造業 | `manufacturing/` | B（01〜16完成／スライド・画像 作業中） |
| 2 | 建設業 | `construction/` | B（01〜16完成／スライド・画像 作業中） |
| 3 | 卸売業 | `wholesale/` | B（01〜16完成／スライド・画像 作業中） |
| 4 | 小売業 | `retail/` | B（01〜16完成／スライド・画像 作業中） |
| 5 | 運輸・物流業 | `logistics/` | A（基盤 作業中） |
| 6 | 飲食業 | `restaurant/` | A（基盤 作業中） |
| 7 | 宿泊業 | `hotel/` | A（基盤 作業中） |
| 8 | 不動産業 | `realestate/` | A（基盤 作業中） |
| 9 | 医療 | `medical/` | - |
| 10 | 介護・福祉 | `care/` | - |
| 11 | 情報通信業 | `ict/` | - |
